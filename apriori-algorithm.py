...
__version__ = '1.1.1'
__author__ = 'Nikola Topalov'
__author_email__ = 'nikolatopalov10@gmail.com'
...
def gen_support_records(transaction_manager, min_support, **
...
def gen_ordered_statistics(transaction_manager, 
    items = record.items
...
def filter_ordered_statistics(ordered_statistics, **
